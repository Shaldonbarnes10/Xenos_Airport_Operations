...
//     const flight = flights.find(f => f.flight_id === flightId); // Store `flights` globally
...
//     // Store the editing flightId
//     document.getElementById('flightForm').setAttribute('data-edit-id', flightId);
// }
